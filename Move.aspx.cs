...
namespace test
{
    public partial class WebForm4 : System.Web.UI.Page
    {
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.AddWithValue("EmployeeContact", AssignedEmployee.SelectedValue);
            ...
            string sqlquery2 = "INSERT INTO [InventoryItem] (ServiceID,ItemName,ItemCost,ItemDescription) VALUES ((SELECT TOP 1 Service.ServiceID FROM Service, Customer WHERE Customer.CustomerID = @CustomerID AND Service.ServiceDate = @ServiceDate ORDER BY Service.ServiceID DESC),@ItemName,@ItemCost,@ItemDescription)";
            ...
            string query2 = "INSERT INTO TicketHistory (TicketChangeDate,EmployeeID,Status,WorkflowID) VALUES (@TicketChangeDate,@EmployeeID,@Status,(SELECT TOP 1 WorkflowID FROM [Workflow] ORDER BY workflowID DESC))";
            SqlConnection sqlconnect = new SqlConnection(" Server=Localhost;Database=GreenValleyAuctions;Trusted_Connection=Yes; ");
            sqlconnect.Open();
            SqlCommand cmd3 = new SqlCommand(query2, sqlconnect);

            cmd3.Parameters.AddWithValue("EmployeeID", AssignedEmployee.SelectedValue);
            cmd3.Parameters.AddWithValue("TicketChangeDate", ServiceDate1);
