...
&nbsp;Email&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <br />
            Employee Started&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:DropDownList ID="InitialContactDDL" runat="server" DataSourceID="SqlDataSource1" DataTextField="EmployeeName" DataValueField="EmployeeID"></asp:DropDownList>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:GreenValleyAuctionsConnectionString12 %>" SelectCommand="SELECT [EmployeeID], [EmployeeName] FROM [Employee]"></asp:SqlDataSource>
            <br />
            <br />
            <br />
            Initial Contact&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           ...
           How They Heard&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <br />
            Service Interest&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:DropDownList ID="serviceinterestddl" runat="server" OnSelectedIndexChanged="serviceinterestddl_SelectedIndexChanged1" CausesValidation="false">
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:GreenValleyAuctionsConnectionString13 %>" SelectCommand="SELECT DISTINCT ServiceType FROM WorkflowType"></asp:SqlDataSource>
            <br />
            <br />
            <br />
            <asp:Label ID="PackDate" runat="server" Text="Pack Date"></asp:Label>
            <asp:TextBox ID="PackDateTxt" runat="server"></asp:TextBox>
            <br />
            <br />
