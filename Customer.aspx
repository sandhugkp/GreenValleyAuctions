...
></asp:Content>
 <asp:Content ID="content2" ContentPlaceHolderID="body" runat="server">
        <asp:SqlDataSource runat="server"
            ID="dsCustomer"
            ConnectionString="<%$ connectionStrings:GreenValleyAuctions %>"
            SelectCommand="SELECT * FROM Customer"
            InsertCommand="Insert INTO [Customer] (CustomerID, CustomerName, CustomerPhone, EmployeeContact, CustomerAddress, CustomerInitialContect, CustomerReference, PhoneType, InterestedService, Origin, Destination, PackDate, DateAndTime, Deadline) values (@CustomerID, @CustomerName, @CustomerPhone, @EmployeeContact, @CustomerAddress, @CustomerInitialContect, @CustomerReference, @PhoneType, @InterestedService, @Origin, @Destination, @PackDate, @DateAndTime, @Deadline)"
            />
    
        <div>
            <asp:Label ID="Name" runat="server" Text="Green Valley Auctions" Font-Size="XX-Large"></asp:Label><br />
            <br />
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" DataSourceID="ConnectionStrng" DataKeyNames="CustomerID" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Visible="false"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="EmployeeContact" HeaderText="EmployeeContact" />
                    <asp:BoundField DataField="CustomerAddress" HeaderText="CustomerAddress" />
                    <asp:BoundField DataField="CustomerInitialContact" HeaderText="CustomerInitialContact" />
                    <asp:BoundField DataField="CustomerReference" HeaderText="CustomerReference" />
                    <asp:BoundField DataField="PhoneType" HeaderText="PhoneType" />
                    <asp:BoundField DataField="InterestedService" HeaderText="InterestedService" />
                    <asp:BoundField DataField="Origin" HeaderText="Origin" />
                    <asp:BoundField DataField="Destination" HeaderText="Destination" />
                    <asp:BoundField DataField="PackDate" HeaderText="PackDate" />
                    <asp:BoundField DataField="DateAndTime" HeaderText="DateAndTime" />
                    <asp:BoundField DataField="Deadline" HeaderText="Deadline" />
                 </Columns>
            </asp:GridView>
            <asp:SqlDataSource
                ID="ConnectionStrng" runat="server" ConnectionString="Server=Localhost;Database=GreenValleyAuctions;Trusted_Connection=Yes;" SelectCommand="SELECT CustomerID, CustomerName, CustomerPhone, EmployeeContact, CustomerAddress, CustomerInitialContect, CustomerReference, PhoneType, InterestedService, Origin, Destination, PackDate, DateAndTime, Deadline FROM Customer" FilterExpression="CustomerName LIKE '%{0}%'" >
                <FilterParameters>
            ...
            <asp:SqlDataSource
                ID="ConnectionStrng1" runat="server" ConnectionString="Server=Localhost;Database=GreenValleyAuctions;Trusted_Connection=Yes;" SelectCommand="Select Workflow.WorkflowID, Workflow.CustomerDate, Service.ServiceName, Workflow.Status FROM Workflow, Service WHERE Service.ServiceID = Workflow.WorkflowID AND Workflow.CustomerID = @CustomerID" >
            ...
            <asp:SqlDataSource ID="ConnectionStrng2" runat="server" ConnectionString="Server=Localhost;Database=GreenValleyAuctions;Trusted_Connection=Yes;"  SelectCommand="Select NoteID, NoteTitle, NoteBody From Notes Where WorkflowID = @WorkflowID" >
            ...
            <asp:GridView ID="Ticketgridv" runat="server" AutoGenerateColumns="false" AutoGenerateSelectButton="true" DataKeyNames="HistoryID" Visible="false" DataSourceID="ConnectionStrng3" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="TicketChangeDate" HeaderText="ChangeDate" />
                     
                </Columns>
            </asp:GridView>
            <asp:SqlDataSource ID="ConnectionStrng3" runat="server" ConnectionString="Server=Localhost;Database=GreenValleyAuctions;Trusted_Connection=Yes;" SelectCommand="SELECT HistoryID, TicketChangeDate FROM TicketHistory WHERE WorkflowID = @WorkflowID" >
                <SelectParameters>
                    <asp:ControlParameter Name="WorkflowID" ControlID="GridView3" PropertyName="SelectedValue" />
                </SelectParameters>
            </asp:SqlDataSource>
            ...
            <br />
             ...
             <asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="false" AutoGenerateSelectButton="true" DataKeyNames="InventoryID" Visible="false" DataSourceID="ConnectionStrng4" 
                  Caption="InventoryItem Info" CaptionAlign="Top" >
                <Columns>
            ...
            <asp:SqlDataSource ID="ConnectionStrng4" runat="server" ConnectionString="Server=Localhost;Database=GreenValleyAuctions;Trusted_Connection=Yes;" SelectCommand="Select InventoryItem.InventoryID, InventoryItem.ItemName, InventoryItem.ItemDescription, InventoryItem.ItemCost From InventoryItem, Workflow Where InventoryItem.ServiceID = Workflow.ServiceID AND Workflow.WorkflowID = @WorkflowID" >
           ...
           <asp:SqlDataSource ID="ConStrng6" runat="server" ConnectionString="Server=Localhost;Database=GreenValleyAuctions;Trusted_Connection=Yes;"
            ...
            <br />
            <br />
            <asp:Button ID="CompletionBtn" runat="server" Text="Completion Form Redirect" OnClick="CompletionBtn_Click" />
            <asp:Button ID="InitialContact" runat="server" Text="Inital Contact Form Redirect" OnClick="InitialContact_Click" />
            <br />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:GreenValleyAuctionsConnectionString2 %>" SelectCommand="SELECT [CustomerID], [CustomerName], [CustomerPhone], [CustomerEmail], [CustomerAddress] FROM [Customer]"></asp:SqlDataSource>
     ...
     <asp:Button ID="EditServiceBtn" runat="server" Text="Edit a Service Ticket" OnClick="EditServiceBtn_Click"/>
      <%--  <asp:GridView ID="GridView2" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:GreenValleyAuctionsConnectionString8 %>" SelectCommand="SELECT [CustomerID], [CustomerName], [CustomerPhone], [CustomerEmail], [CustomerAddress] FROM [Customer]"></asp:SqlDataSource>
</asp:Content>