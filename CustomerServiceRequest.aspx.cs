...
namespace GreenValleyAuctions
{
    public partial class WebForm3 : System.Web.UI.Page
    {
        ...
        protected void ServiceRequestBtn_Click(object sender, EventArgs e)
        {
            ...
            sqlConnect.Open();
            string sqlquery = "INSERT INTO [NotificationLog] (ServiceType, Date, DescriptionOfNeeds,InitialCustomerID) VALUES (@ServiceType,@Date,@DescriptionOfNeeds, (SELECT InitialCustomerID From InitialContact WHERE CustomerEmail = @CustomerEmail))";
