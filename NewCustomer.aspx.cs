    ...
    public partial class WebForm2 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["Notification"] != null)
            {
                ...
                cmd1.CommandText  = "SELECT NotificationLog.ServiceType, NotificationLog.Date, InitialContact.CustomerName, InitialContact.CustomerEmail, InitialContact.CustomerAddress, InitialContact.CustomerPhone FROM NotificationLog, InitialContact WHERE NotificationLog.NotificationCountID = @Count AND NotificationLog.InitialCustomerID = InitialContact.InitialCustomerID";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection sqlConnect = new SqlConnection(" Server=Localhost;Database=GreenValleyAuctions;Trusted_Connection=Yes; ");
            sqlConnect.Open();
            string sqlquery = "INSERT INTO [Customer] (CustomerName,CustomerAddress,CustomerPhone,CustomerEmail,EmployeeContact,CustomerInitialContact,CustomerReference,PhoneType,InterestedService,PackDate,Origin,Destination,DateAndTime,Deadline)";
            sqlquery += " VALUES (@CustomerName, @CustomerAddress,@CustomerPhone,@CustomerEmail,@EmployeeContact,@CustomerInitialContact,@CustomerReference,@PhoneType,@InterestedService,@PackDate,@Origin,@Destination,@DateAndTime,@Deadline)";
            ...
            string employee = InitialContactDDL.SelectedItem.ToString();
            ...
            string Packdate = HttpUtility.HtmlEncode(PackDateTxt.Text);
            cmd.Parameters.AddWithValue("PackDate", Packdate);
        ...
        protected void InitialContactDDL_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        protected void serviceinterestddl_SelectedIndexChanged1(object sender, EventArgs e)
        {
