...
namespace test
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        //    SqlConnection workflowsqlconnect = new SqlConnection("Server=Localhost;Database=GreenValleyAuctions;Trusted_Connection=Yes;");
        ...
        protected void CompletionBtn_Click(object sender, EventArgs e)
        {
            Response.Redirect("CompletionForm.aspx");
        }

        protected void InitialContact_Click(object sender, EventArgs e)
        {
